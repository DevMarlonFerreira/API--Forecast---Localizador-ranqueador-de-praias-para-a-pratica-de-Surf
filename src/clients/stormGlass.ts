...
export interface StoreGlassPoint {
...
export class StormGlass {
  ...
  private isValidPoint(point: Partial<StoreGlassPoint>): boolean {
    return !!(point.time && point.swellDirection?.[this.stormGlassAPISource],
